...
if __name__ == "__main__":
    ...
    num_actions = 2
    gamma = 0.95
    env = OffloadEnv(True, args.lambd, args.offload_cost, args.overload_cost, args.holding_cost, args.reward, args.N, args.seed, args.env_name, args.folder, args.start_iter, args.step)
